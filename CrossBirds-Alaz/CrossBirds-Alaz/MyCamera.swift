...
class MyCamera: SKCameraNode {  //this method doesn not let the user moce the camera beyond our background image, thus, eleminating the blackspaces the user can see by restricting the user.
